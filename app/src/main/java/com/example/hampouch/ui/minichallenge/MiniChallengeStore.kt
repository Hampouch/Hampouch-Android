...
object MiniChallengeStore : AccountScopedState, MiniChallengeLocalStore {
    ...
    override fun setSummaryForDate(date: LocalDate, summary: MiniChallengeDaySummary) {
    ...
    override fun toggle(date: LocalDate, id: String) {
    ...
    override fun addChallenge(date: LocalDate, name: String, totalDays: Int?): Boolean {
    ...
    override fun addRecommendedChallenge(date: LocalDate, recommended: RecommendedMiniChallenge): Boolean {
    ...
    override fun removeChallenge(date: LocalDate, id: String) {
